                            ...
                            <div class="flex flex-col">
                                <div>
                                    ...
                                    <textarea v-model="remarks"
                                        class="w-full border-0 bg-gray-100 focus:bg-white rounded text-black outline-none focus:ring-opacity-0"></textarea>
                                </div>
                            </div>
                        </form>
                        <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                            <button type="button" @click="updateContract('Approved')"
                                    class="mx-2 mt-3 w-auto inline-flex justify-center rounded-md shadow-sm px-2 py-2 font-bold text-white bg-green-400 hover:bg-green-600">
                                I will Approve this contract
                            </button>
                            <button type="button" @click="updateContract('Declined')"
                                    class="mx-2 mt-3 w-auto inline-flex justify-center rounded-md shadow-sm px-2 py-2 font-bold text-white bg-red-400 hover:bg-red-600">
                                I will Decline this contract
                            </button>
                            <button type="button" v-on:click="approval_mdl = false"
                                    class="mx-2 mt-3 w-auto inline-flex justify-center rounded-md shadow-sm px-2 py-2 font-bold text-white bg-gray-400 hover:bg-gray-600">
                                Cancel
                            </button>
                        </div>
                    </div>
