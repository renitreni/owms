        ...
        <td style="width: 84.1449%;">
            <table style="width: 100%;">
                ...
                <tr>
                    ...
                    <td style="width: 61.4035%;"><span style="font-family: Tahoma,Geneva, sans-serif;">
                            {{ $results->position_1 }}, {{ $results->position_2 }}, {{ $results->position_3 }}</span>
                    </td>
                </tr>
                <tr>
                    <td style="width: 38.4615%; background-color: rgb(84, 172, 210);">
...
<table style="width: 100%; margin-right: calc(1%);">
    <tbody>
    <tr>
        <td style="width: 60.1597%;">
            <table style="width: 99%; margin-right: calc(0%); margin-left: calc(1%);">
                <tbody>
                <tr>
                    <td style="width: 41.556%; background-color: rgb(84, 172, 210); text-align: right;"><br></td>
                ...
                <tr>
                    <td style="width: 41.556%; background-color: rgb(84, 172, 210); text-align: right;"><span
                            style="font-family: Tahoma,Geneva, sans-serif;"><span style="color: rgb(239, 239, 239);">APPLICANT NAME&nbsp;</span></span>
                    </td>
                ...
                <tr>
                    <td style="width: 41.556%; background-color: rgb(84, 172, 210); text-align: right;"><span
                            style="color: rgb(239, 239, 239); font-family: Tahoma, Geneva, sans-serif;">NATIONALITY&nbsp;</span>
                    </td>
            ...
            <table style="width: 100%; margin-right: calc(0%);">
                ...
                <tr>
                    <td style="width: 100%; text-align: center;">{{ $results->skills }}</td>
                </tr>
                <tr>
                    <td style="width: 100%; text-align: center; background-color: rgb(84, 172, 210);"><strong><span
                                style="font-family: Tahoma, Geneva, sans-serif; color: rgb(239, 239, 239);">LANGUAGE SPOKEN</span></strong>
                    </td>
                </tr>
                <tr>
                    <td style="width: 100%; text-align: center;">{{ $results->language }}</td>
                </tr>
                </tbody>
            </table>
        </td>
...
<table style="width: 100%;">
    ...
    <tr>
        ...
        <td style="width: 25%; background-color: rgb(84, 172, 210);">
            <div data-empty="true" style="text-align: center;"><span
                    style="color: rgb(255, 255, 255); font-family: Tahoma, Geneva, sans-serif;">POSITION</span></div>
        </td>
        <td style="width: 25%; background-color: rgb(84, 172, 210);">
            <div data-empty="true" style="text-align: center;"><span
