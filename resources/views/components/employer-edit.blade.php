                ...
                <div class="mt-10 sm:mt-0">
                    <div class="md:grid md:grid-cols-1">
                        <div class="mt-5 md:mt-0 md:col-span-1">
                            <form action="{{ route('employers.update', ['id' => $id]) }}" method="POST">
                                @csrf
                                <div class="shadow overflow-hidden sm:rounded-md">
                                        ...
                                        <div class="grid grid-cols-6 gap-6 sm:grid-cols-6">
                                            ...
                                            <div class="col-span-6 sm:col-span-2">
                                                ...
                                                <input type="text" name="contact_name" id="contact_name"
                                                       autocomplete="contact_name" value="{{ $employer->contact_name }}"
                                                       class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                            </div>
                                            ...
                                            <div class="col-span-6 md:col-span-2">
                                                ...
                                                <select id="status" name="status" autocomplete="status"
                                                    ...
                                                    <option value="active"
                                                            @if($employer->status == 'active') selected @endif>Active
                                                    </option>
                                                    <option value="not active"
                                                            @if($employer->status == 'not active') selected @endif>Not
                                                        Active
                                                    </option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-span-6 md:col-span-2">
                                                <label class="block text-sm font-medium text-gray-700">Business
                                                    Type</label>
                                    ...
                                    <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                                        <a href="{{ route('employers.delete', ['id'=>$id]) }}"
