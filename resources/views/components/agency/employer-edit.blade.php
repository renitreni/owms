                                ...
                                <div class="shadow overflow-hidden sm:rounded-md">
                                    <div class="grid grid-cols-12 gap-2 p-4">
                                        ...
                                        <div class="md:col-span-4 col-span-12">
                                            ...
                                            <input type="text" name="national_id" autocomplete="national_id" value="{{ $user->national_id }}"
                                                   class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                        </div>
                                        {{--                                        Contact Person--}}
                                        ...
                                        <div class="col-span-6 md:col-span-2">
                                            ...
                                            <select id="status" name="status" autocomplete="status"
                                                ...
                                                <option value="active" @if($user->information->status == 'active') checked @endif>{{ __('Active') }}</option>
                                                <option value="not active" @if($user->information->status == 'not active') checked @endif>{{ __('Not Active') }}</option>
                                            </select>
                                        </div>
                                        {{--                                        Business Type--}}
                                        <div class="col-span-6 md:col-span-2">
