        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-x-auto shadow-sm sm:rounded-lg p-5 pt-8">
                <div class="flex flex-col sm:flex-row">
                    ...
                    <div class="sm:pl-6 mt-4 sm:mt-0">
                        <form class="flex flex-col" method="POST" action="{{ route('details.insert.checklist') }}">
                            @csrf
                            ...
                            <div class="flex flex-row">
                                <input name="name" class="shadow appearance-none border border-gray-300 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text">
                                <button type="submit"
                                        class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-green-600 text-base font-medium text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 sm:ml-3 sm:w-auto sm:text-sm">
                                    <i class="fas fa-plus-circle m-auto"></i>
                                </button>
                            </div>
                        </form>
                        <div class="mt-3">
