                ...
                <div class="mt-10 sm:mt-0">
                    <div class="md:grid md:grid-cols-1">
                        <div class="mt-5 md:mt-0 md:col-span-1">
                            <form action="{{ route('affiliates.update',['id' => $user->id]) }}" method="POST">
                                @csrf
                                <div class="shadow overflow-hidden sm:rounded-md">
                                    ...
                                    <div class="shadow overflow-hidden">
                                        <div class="bg-gray-50 text-right pr-3 py-3">
                                            <a href="{{ route('affiliates.resetpass', ['id' => $user->id]) }}" class="mt-1 inline-flex justify-center py-2 px-4 border
                                                    border-transparent shadow-sm text-sm font-medium rounded-md text-white
                                                    bg-yellow-500 hover:bg-yellow-600 focus:outline-none focus:ring-2
                                                    focus:ring-offset-2 focus:ring-indigo-500">
                                                Reset Pass
                                            </a>
                                            <a href="{{ route('affiliates.delete', ['id' => $user->id]) }}" class="inline-flex justify-center py-2 px-4 border
                                        border-transparent shadow-sm text-sm font-medium rounded-md text-white
